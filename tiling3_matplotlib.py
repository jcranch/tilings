...
def matplotlib_display_tiling3(tiling_3_on = True,intersection_tiling2_on = True,\
                               ...
                               axis_3D_intersection_tiling2_on = True, save_on = True, save_name = 'demos/tiling3_figure'):
    figure = plt.figure()
    axis = Axes3D(figure)
