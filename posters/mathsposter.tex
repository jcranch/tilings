...
\includegraphics[clip,trim={5cm 1cm 5cm 1cm},scale = 0.6]{hypercube}
\end{wrapfigure}
...
So what does it look like for a four-dimensional hyper-cube to pass through our three-dimensional world?
...
This suggests that a four-dimensional hyper-cube is like a three-dimensional cube being \emph{dragged} in the fourth dimension we cannot see. 
\par
However, this is not the only way a four-dimensional hyper-cube can pass through. To the right (lower) we see what it looks like for a four-dimensional hyper-cube to pass through at a different angle.
...
\item the four-dimensional hyper-cube and four-dimensional hyper-octahedron are dual to each other,
\item the hyper-icosahedron and hyper-dodecahedron are dual to each other,
\item and the 24-cell is dual to itself.
\end{itemize}
For $n\ge 5$ we just have that the $n$-dimensional simplex is dual to itself while the $n$-dimensional hyper-cube and hyper-octahedron are dual to one another.
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item the third example seems slightly more complex. It seems to consist of three different three-dimensional objects that use non-regular hexagons, isosceles kites and rhombi as faces. 
\end{itemize}
\quad \par
